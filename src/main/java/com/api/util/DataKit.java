...
//                String rgexSubIn = "in =(.*?)";　//以换行结束
                ...
                int paramLength=10;
                Object paramKeyvalue= com.api.util.DataKit.GeneratorDataByTyPe(paramType,paramLength);
...
//        String str = "{name : 'test' , age: 'Random(Long[2])' , detail: 'Random(String[50,60])' , isStudent: 'Random(Boolean)' }";
        ...
        while (m.find()){
            ...
            Object randomVal =  com.api.util.DataKit.ranDomData(randomStr);
            try {
