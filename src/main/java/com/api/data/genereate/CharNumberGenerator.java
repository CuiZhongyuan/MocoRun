...
public class CharNumberGenerator {
    ...
    public static String generateLetter(int start ,int end){
        StringBuffer sb = new StringBuffer();
        int length = NumberGenerator.randomInt(start,end);
    ...
    public static Long generateLong(int start ,int end){
        StringBuffer sb = new StringBuffer();
        int length = NumberGenerator.randomInt(start,end);
        while (sb.length() != length){
            sb.append(INT_CHAR.charAt(random.nextInt(INT_CHAR.length()-1)));
        }
